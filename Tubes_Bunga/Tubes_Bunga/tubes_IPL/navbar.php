      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <!-- <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false"> Login </a>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="loginuser.php">Login User</a>
          ...
          <li class="nav-item active">
            <a class="nav-link" href="J_moobil.html">Daftar Paket<span class="sr-only"></span></a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="Pembayaran_Antrian.php">Pembayaran</a>
            </div>
          </li>
          <!-- Informasi login -->
          <?php if (isset($user_id)) : ?>
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <span class="nav-link">Selamat datang, <?php echo $username; ?></span>
              </li>
